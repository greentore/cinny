    ...
    <ScrollView invisible>
      <div className="auth__base">
          ...
          {!loginToken && (
            <div className="auth-card">
              <Header>
                ...
                <TitleWrapper>
                  <Text variant="h2" weight="medium">Greeny</Text>
                </TitleWrapper>
              </Header>
        ...
        <div className="auth-footer">
          <Text variant="b2">
            <a href="https://github.com/greentore/greeny" target="_blank" rel="noreferrer">About</a>
          </Text>
          <Text variant="b2">
            <a href="https://github.com/greentore/greeny/releases" target="_blank" rel="noreferrer">{`v${cons.version}`}</a>
          </Text>
          <Text variant="b2">
